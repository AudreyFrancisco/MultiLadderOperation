...
INCLUDE=-I/usr/local/include -I. -I./inc -I./MosaicSrc -I$(LIBMOSAIC_DIR)/include -I$(LIBPOWERBOARD_DIR)/include -I$(LIBALUCMS_DIR) -I/usr/include/libxml2
LIB=-L/usr/local/lib -L$(LIBPOWERBOARD_DIR) -lpowerboard -L$(LIBMOSAIC_DIR) -lmosaic -L$(LIBALUCMS_DIR) -lalucms -lxml2 -lcurl
CFLAGS= -O2 -pipe -fPIC -g -std=c++14 -m64 -Wall -Werror -pedantic $(MCMODEL) $(INCLUDE) -DVERSION=\"$(GIT_VERSION)\"
