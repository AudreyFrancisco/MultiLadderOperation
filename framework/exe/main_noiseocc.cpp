/**
 * \brief This executable runs the noise occupancy scan test for all enabled chips in the device.
 *
 * \note
...
// ./test_noiseocc -v 1 -c ../config/ConfigMFTladder_NoiseOccScan.cfg -l 25
//
